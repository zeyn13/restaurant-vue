<template>
    <div class="header">
        ...
        <div v-if="!user" class="fas fas-user account" @click="showLog">
    ...
    <div v-else class="fas fas-user account" style="background: #f38609;color: white;" @click="showLog">
        <ul class="drop-down-select">
            <li>
                <router-link @click="scrollToTop()" to="/myorder">myorder</router-link>
            </li>
            <li>
...
@media (max-width: 768px) {
    .header .navbar {
        ...
        right: 0;
        background: #fff;
        border-top: 0.1rem solid rgba(0, 0, 0, 0.02);
