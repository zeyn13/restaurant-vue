    ...
    <div class="box-container">
      <div class="box">
        ...
        <router-link @click="scrollToTop()" to="/menu"
          ><i class="fas fa-arrow-right"></i>Taco</router-link
        >
        <router-link @click="scrollToTop()" to="/menu"
          ><i class="fas fa-arrow-right"></i>Burrito</router-link
        >
        <router-link @click="scrollToTop()" to="/menu"
          ><i class="fas fa-arrow-right"></i>Nachos</router-link
        >
        <router-link @click="scrollToTop()" to="/menu"
          ><i class="fas fa-arrow-right"></i>Side Food
        </router-link>
        <router-link @click="scrollToTop()" to="/menu"
          ><i class="fas fa-arrow-right"></i>Dessert</router-link
        >
        <router-link @click="scrollToTop()" to="/menu"
          ><i class="fas fa-arrow-right"></i>Drink</router-link
        >
      </div>
      ...
      <div class="box">
        <h3>Opening Hours</h3>
        <p>Everyday: 07:00am to 10:00pm</p>
      </div>
    </div>
